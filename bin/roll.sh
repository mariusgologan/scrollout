...
sudo dpkg -i /var/www/cfg/geo/libip-country-perl_2.27-1_all.deb
sudo apt-get install libtext-csv-xs-perl -y
sudo sa-update
...
for service in nginx rsyslog redis-server zebra postsrsd unattended-upgrades php7.0-fpm incron cron; do
