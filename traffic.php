...
?>
			...
			<div class="button1" href="javascript:void(0)" onclick="toggle_visibility(event,'<?= $domains[$count] ?>_spam');"><i class="fa fa-recycle fa-fw fa-2x"></i>
			<div class="style11">Quarantine</div>
			</div>
			<div class="button1" href="javascript:void(0)" onclick="toggle_visibility(event,'<?= $domains[$count] ?>_IN');"><i class="fa fa-sign-in fa-fw fa-2x"></i>
			<div class="style11">Inbound</div>
			</div>

			<div class="button1" href="javascript:void(0)" onclick="toggle_visibility(event,'<?= $domains[$count] ?>_OUT');"><i class="fa fa-sign-out fa-fw fa-2x"></i>
			<div class="style11">Outbound</div>
			</div>

<!--			<div class="button1" href="javascript:void(0)" onclick="toggle_visibility(event,'<?= $domains[$count] ?>_IPSec')'">&nbsp;IPSec&nbsp;
